...
import CustomBlockHeader from './CustomBlockHeader.js';
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <CustomerItem
          ...
          imgphone={require('../../../assets/images/ic_phone.png')}
          phonenumber="0987654321"
          imgaddress={require('../../../assets/images/ic_location.png')}
          address="Toàn quốc"
          imguser={require('../../../assets/images/ic_user.png')}
    ...
    return (
      <View style={styles.v_item}>
        ...
        <View style={styles.v_optionitem}>
          <CustomOneOption
            imgoption={require('../../../assets/images/ic_messenger.png')}
            nameoption="Chat"
          />
          <CustomOneOption
            imgoption={require('../../../assets/images/ic_zalo.png')}
            nameoption="Zalo"
          />
          <CustomOneOption
            imgoption={require('../../../assets/images/ic_phoneblue.png')}
            nameoption="Gọi điện"
          />
        </View>
      </View>
