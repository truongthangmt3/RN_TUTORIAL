...
import CustomBlockHeader from './CustomBlockHeader';
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        ...
        <CustomOnenotify
          icon={require('../../../assets/images/ImgUserScreen/ic_pheduyet.png')}
          text="This is a notification"
          date="1/12020"
        />
        <View style={styles.v_line}></View>
        <CustomOnenotify
          icon={require('../../../assets/images/ic_tuchoi.png')}
          text="This is a notification"
          date="1/12020"
        />
        <View style={styles.v_line}></View>
        <CustomOnenotify
          icon={require('../../../assets/images/ic_timkiem.png')}
          text="This is a notification"
          date="1/12020"
        />
        <View style={styles.v_line}></View>
        <CustomOnenotify
          icon={require('../../../assets/images/ic_canmua.png')}
          text="This is a notification"
          date="1/12020"
        />
        <View style={styles.v_line}></View>
