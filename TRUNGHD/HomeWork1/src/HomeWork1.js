    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.v_stories}>
          <Text style={styles.sug_text}>Suggested Stories</Text>
          <View style={styles.v_story}>
            <ScrollView
              horizontal={true}
              showsHorizontalScrollIndicator={false}>
              {_funcStory(require('../assets/ic_addstory.png'), 'Add Stories')}
              {_funcStory(require('../assets/ic_story_thinh.png'), 'Thinh')}
