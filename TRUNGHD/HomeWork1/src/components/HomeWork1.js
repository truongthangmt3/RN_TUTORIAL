...
export default class HomeWork1 extends Component {
  ...
  //   current: 0,
  //   isNotification: true,
  //   girl_img: [image.img_avatar, image.ic_thangprofile, image.ic_thinhProfile],
  // };
  render() {
    //const {girl_img, current, isNotification} = this.state;
    return (
      <HomeScreen />
      // <SafeAreaView style={styles.container}>
      //   <View style={styles.header_block}>
      //     <Text style={styles.text_dating}>Dating</Text>
      //     <View style={styles.v_setting}>
      //       <Image style={styles.img_setting} source={image.ic_setting} />
      //     </View>
      //   </View>
      //   <View style={styles.v_action_block}>
      //     <CustomButton
      //       img={image.ic_profile}
      //       label="Profile"
      //       action={this._func_ClickToProfile}
      //       isNotification={isNotification}
      //     />
      //     <CustomButton
      //       img={image.ic_likedyou}
      //       label="Liked You"
      //       action={_func_ClickToLikedYou}
      //       isNotification={false}
      //     />
      //     <CustomButton
      //       img={image.ic_match}
      //       label="Matches"
      //       action={_func_ClickToMatches}
      //       isNotification={false}
      //     />
      //   </View>
      //   <View style={styles.v_avatar}>
      //     <View style={styles.v_avatar_profile}>
      //       <Image style={styles.v_img_avatar} source={girl_img[current]} />
      //       <View style={styles.v_avatar_button}>
      //         <TouchableOpacity
      //           onPress={() => {
      //             tmpImg = current;
      //             if (tmpImg < girl_img.length - 1) {
      //               tmpImg++;
      //             } else {
      //               tmpImg = 0;
      //             }
      ...
      //             });
      //           }}>
      //           <Image style={styles.avatar_button} source={image.ic_cancel} />
      //         </TouchableOpacity>
      //         <Image style={styles.avatar_button} source={image.ic_heart} />
      //       </View>
      //     </View>
      //     <View style={styles.v_infor}>
      //       <Text style={styles.text_nameavatar}>Name, 18</Text>
      //       <Text style={styles.text_addressavatar}>Hanoi</Text>
      //     </View>
      //   </View>
      //   <View style={styles.boder_line} />
      //   <View style={styles.v_stories}>
      //     <Text style={styles.text_suggested}>Suggested Stories</Text>
      //     <View style={styles.v_story}>
      //       <ScrollView
      //         horizontal={true}
      //         showsHorizontalScrollIndicator={false}>
      //         {_funcStory(image.ic_addstory, 'Add Stories')}
      //         {_funcStory(image.ic_story_thinh, 'Thịnh')}

      //         {_funcStory(image.ic_thinhProfile, 'Thịnh')}

      //         {_funcStory(image.ic_thangprofile, 'Thắng')}

      //         {_funcStory(image.ic_story2, 'Name')}
      //         {_funcStory(image.ic_story3, 'Name')}
      //         {_funcStory(image.ic_story4, 'Name')}
      //       </ScrollView>
      //     </View>
      //   </View>
      //   <View style={styles.boder_line} />
