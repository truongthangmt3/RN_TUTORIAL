...
//                             <View >
//                                 <ImageBackground source={R.images.ic_Rectangle} style={styles.img_herder} >
...
import { getHomeInfoAction, getTruInfoAction } from '@action'
        ...
        return (
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        this.props.getHomeInfoAction("Add");
                    }}
                >
                ...
                <TouchableOpacity
                    onPress={() => {
                        this.props.getTruInfoAction("Add2");
                    }}
                >
