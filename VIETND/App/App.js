    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        <Image
          ...
          source={require('./assets/img_gai.jpg')}
        />
      ...
      <View >
        ...
        <View style={styles.boder_radius}>
          ...
          <ScrollView horizontal={true}>
            ...
            {_funcbody_2(require('./assets/ic_add.png'), 'Add Story', _buttonstory)}
            {_funcbody(require('./assets/img_gai.jpg'), 'Linh', _buttonstory)}
            {_funcbody(require('./assets/img_gai2.jpg'), 'Hoa', _buttonstory)}
            {_funcbody(require('./assets/img_gai3.jpg'), 'Phương', _buttonstory)}
            {_funcbody(require('./assets/img_gai4.jpg'), 'Đạt', _buttonstory)}
            {_funcbody(require('./assets/img_gai5.jpeg'), 'Thảo', _navToProfile)}
            {_funcbody(require('./assets/img_gai.jpg'), 'Hương', _buttonstory)}
          </ScrollView>
        </View>
